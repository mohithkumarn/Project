Webruntime.define('lwc/bearTile', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';

	function stylesheet(hostSelector, shadowSelector, nativeShadow) {
	  return ".pic" + shadowSelector + " {height: 100px;}\n";
	}
	...
	**/
	...
	function tmpl$6($api, $cmp, $slotset, $ctx) {
	  ...
	  return [api_custom_element("lightning-card", _lightningCard, {
	    ...
	    key: 4
	  }, [api_text("Despcription: "), api_dynamic($cmp.bear.Despcription__c)]), api_element("p", {
	    classMap: {
	      "slds-m-bottom_xx-small": true
	    },
	    key: 5
	  }, [api_text("Comments: "), api_dynamic($cmp.bear.Comments__c)]), api_element("p", {
	    classMap: {
	      "slds-m-bottom_xx-small": true
	    },
	    key: 6
	  }, [api_text("Bear Name: "), api_dynamic($cmp.bear.Bear__r.Name)])])])])])];
	}
	...
	tmpl$6.stylesheetTokens = {
	  hostAttribute: "lwc-bearTile_bearTile-host",
	  shadowAttribute: "lwc-bearTile_bearTile"
	};

	var ursusResources = '/assets/project/989f84b0e4/staticresources/ursus_park';

	class BearTile extends lwc.LightningElement {
	  constructor(...args) {
	    super(...args);
	    this.bear = void 0;
	    this.appResources = {
	...
	lwc.registerDecorators(BearTile, {
	  publicProps: {
	    bear: {
	      config: 0
	    }
	...
	var bearTile = lwc.registerComponent(BearTile, {
	  tmpl: _tmpl$7
	});

Webruntime.define('lwc/tasktile', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    **/
    ...
    function tmpl$6($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        props: {
          ...
          "iconClass": "bear-tile-button",
          "variant": "bare",
          "alternativeText": "Open record"
        },
        key: 0,
        on: {
          "click": _m0 || ($ctx._m0 = api_bind($cmp.handleOpenRecordClick))
        }
      }, [])]), api_element("div", {
        classMap: {
        ...
        key: 3
      }, [api_text("Employee : "), api_dynamic($cmp.bear.Employee__r.Name)]), api_element("p", {
        classMap: {
          "slds-m-bottom_xx-small": true
        },
        key: 4
      }, [api_text("Task : "), api_dynamic($cmp.bear.Onboaring_Step__r.Name)]), api_element("p", {
        classMap: {
          "slds-m-bottom_xx-small": true
        },
        key: 5
      }, [api_text("Status: "), api_dynamic($cmp.bear.Status__c)]), api_element("p", {
        classMap: {
          "slds-m-bottom_xx-small": true
        },
        key: 6
      }, [api_text("Due Date: "), api_dynamic($cmp.bear.Due_Date__c)]), api_element("p", {
        classMap: {
          "slds-m-bottom_xx-small": true
        },
        key: 7
      }, [api_text("Duration: "), api_dynamic($cmp.bear.Duration__c)])])])])])];
    }

    var _tmpl$7 = lwc.registerTemplate(tmpl$6);
    tmpl$6.stylesheets = [];
    tmpl$6.stylesheetTokens = {
      hostAttribute: "lwc-tasktile_tasktile-host",
      shadowAttribute: "lwc-tasktile_tasktile"
    };

    var ursusResources = '/assets/project/ac69ec550c/staticresources/ursus_park';

    class tasktile extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.bear = void 0;
        this.appResources = {
    ...
    lwc.registerDecorators(tasktile, {
      publicProps: {
        bear: {
          config: 0
        }
    ...
    var tasktile$1 = lwc.registerComponent(tasktile, {
      tmpl: _tmpl$7
    });
